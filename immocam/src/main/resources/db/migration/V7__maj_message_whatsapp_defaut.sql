...
SET valeur = 'Bonjour {proprietaire}, je suis interesse(e) par votre annonce Bailocam : {type} a {quartier}, {ville} — {prix}. Est-elle toujours disponible ?',
    description = 'Message pre-rempli WhatsApp (placeholders: {proprietaire}, {type}, {quartier}, {ville}, {prix})'
WHERE cle = 'MSG_WHATSAPP'
  AND valeur = 'Bonjour, je vous contacte depuis Bailocam concernant votre annonce : {type} a {quartier}, {ville} — {prix} FCFA. Est-il toujours disponible ?';
