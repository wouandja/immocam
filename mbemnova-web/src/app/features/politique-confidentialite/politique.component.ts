  ...
  template: `
    <div class="max-w-3xl mx-auto px-4 py-8">
      ...
      <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-8 mt-4 prose prose-slate max-w-none">
        ...
        <p class="text-slate-400 text-sm mb-6">En vigueur depuis juin 2026 — ImmoCam</p>

        <h2 class="text-lg font-bold text-slate-800 mt-6 mb-3">1. Responsable du traitement</h2>
        <p class="text-slate-600 text-sm leading-relaxed mb-4">
          ImmoCam est responsable du traitement des données personnelles collectées sur la
          plateforme. Pour toute question relative à vos données, contactez-nous à
          <a href="mailto:contact@immocam.cm" class="text-blue-700 hover:underline">contact@immocam.cm</a>.
        </p>

        <h2 class="text-lg font-bold text-slate-800 mt-6 mb-3">2. Données collectées</h2>
        <p class="text-slate-600 text-sm leading-relaxed mb-4">
          ImmoCam collecte : prénom, nom, email, numéro de téléphone, ville. Ces données sont
        ...
        <p class="text-slate-600 text-sm leading-relaxed mb-4">
          ImmoCam ne vend jamais vos données à des tiers et ne les partage pas avec des partenaires
        ...
        <p class="text-slate-600 text-sm leading-relaxed mb-4">
          ImmoCam utilise uniquement les cookies strictement nécessaires au fonctionnement du
